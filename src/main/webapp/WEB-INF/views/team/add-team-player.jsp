                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card" style="margin-top: 10px">
                            <div class="card-body">
                                <h5 class="card-title">Add team player</h5>
                                <form:form  class="form-group" action="${pageContext.request.contextPath}/team/add-team-player" method="post" modelAttribute="idList">
                                    <input type="hidden" name="team_id" value="${team.id}"/>

                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label for="team_name"> Team: ${team.name}</label>
                                            <form:select id="team_name" class="form-control" multiple="true" path="ids" items="${players}" itemValue="id" itemLabel="name"/>
                                        </div>
                                    </div>
