package com.noor.blog.config.security;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .and()
                ...
                .antMatchers("/country/show-all").hasAnyRole("SUPER_ADMIN","ADMIN","PLAYER","COACHING_STAFF","USER")
                ...
                .antMatchers("/team/team-members").hasAnyRole("SUPER_ADMIN","ADMIN","PLAYER","USER")
                ...
                .antMatchers("/staff/show-all").hasAnyRole("SUPER_ADMIN","ADMIN","TEAM_MANAGER","PLAYER","USER")
                .antMatchers("/post/write-post").hasAnyRole("SUPER_ADMIN","ADMIN","TEAM_MANAGER","PLAYER","USER")
                .antMatchers("/post/show-all").hasAnyRole("SUPER_ADMIN","ADMIN","TEAM_MANAGER","PLAYER","USER")
                .antMatchers("/post/edit").hasAnyRole("SUPER_ADMIN","ADMIN","TEAM_MANAGER","PLAYER","USER")
