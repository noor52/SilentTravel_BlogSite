...
//import com.fardoushlab.iccweb.dtos.UsersStat;
...
//
//    public UserRootService(HibernateConfig config) {
//        this.config = config;
//    }
//
//    @Transactional
...
//        Root<User> root = userCriteriaQuery.from(User.class);
//
//        userCriteriaQuery.where(cb.equal(root.get("name"), name));
//        var query = session.createQuery(userCriteriaQuery);
//
//        var userList = new ArrayList<User>();
//        try {
...
//        Root<User> root = userCriteriaQuery.from(User.class);
//
//        userCriteriaQuery.where(cb.equal(root.get("username"),userDto.getName()));
//
//        var query  = session.createQuery(userCriteriaQuery);
//        var user = new User();
//        try {
